...
$noheader = ($noheader == 0)?'':'&noheader=1';
  ...
  public function build_menus(){
    ...
    add_submenu_page('pluginers_settings', 'System Error Log', 'System Error Log', 'delete_pages', 'pluginers_error_log', array('pluginers_modules', 'error_log'));*/
      add_menu_page('Infinity', 'BlogXpress', 'delete_pages', 'pluginers_settings', array('pluginers_controller', 'settings'), 'dashicons-admin-site', 6);
      add_submenu_page('pluginers_settings', 'Tetapan', 'Tetapan', 'delete_pages', 'pluginers_settings', array('pluginers_controller', 'settings'));

      add_submenu_page('pluginers_settings', 'Kempen', 'Kempen', 'delete_pages', 'pluginers_manage_rss', array('pluginers_modules', 'manage_rss'));
      ...
      add_submenu_page('pluginers_settings', 'Lesen', 'Lesen', 'delete_pages', 'pluginers_license', array('pluginers_modules', 'license'));
