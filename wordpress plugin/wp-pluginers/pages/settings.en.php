...
$_meta_box_controller->_fill([
    ...
    new _box('publish_author_id','Author Username', function () {
        echo '<div class="form-required">
                                                <input name="publish_author_id" class="form-required" type="text" size="20" value="'.self::$settings['publish_author_id'].'" aria-required="true">
...
$_meta_box_controller->_fill([
    ...
    new _box('google_api_key','Google API Key', function () {
        echo '<input name="google_keys[0]" type="text" size="40" value="'.self::$settings['google_keys'][0].'" aria-required="true" />
                                                <p class="howto">Set your own Google API key to avoid the queries limitations. For how <a href="https://www.youtube.com/embed/4vOLmL1FAoo" target="_blank">click here</a></p><p class="howto">Also watch our training video to learn how to apply for your own Google API key</p>';
    },_box::style_orange),
            ...
            <?php wp_nonce_field( 'closedpostboxes', 'closedpostboxesnonce', false ); ?>
                ...
                <div id="poststuff">
                    ...
                    <div id="plugineer-settings-page" class="metabox-holder columns-2">
                        ...
                        <h2 class="accordion active" style="clear:both;">Basic Configuration</h2>
                       ...
                       <h2 class="accordion active" style="clear:both;">Configuration Data</h2>
                       ...
                       <h2 class="accordion active" style="clear:both;">Integration</h2>
