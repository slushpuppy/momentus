        ...
        <div class="col-wrap">
          ...
          <table class="wp-list-table widefat fixed tags pluginers-tb" cellspacing="0">
            ...
            <tfoot style="display:none">
              ...
              <tr>
                <th colspan="5" scope="col" class="manage-column"><span>Shares</span></th>
            ...
            <tbody id="the-list" data-wp-lists="list:tag">
              <?php if ($feeds): $counter = 0;foreach ($feeds AS $feed): $counter++; ?>
                  <tr id="pluginers-service-tab-<?php echo $feed->id; ?>" class="pluginers-service-tab <?php if ($counter % 2 == 0) {echo 'alternate';} ?>">
                    ...
                    <td class="description column-description pluginers-txt-center"><?php echo ($feed->fb_likes > 1000)? round($feed->fb_likes/1000, 1).'K':$feed->fb_likes;$feed->fb_likes; ?></td>
